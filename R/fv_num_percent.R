...
#' @param \ldots ignored.
#' @return Returns a vector of parenthesis combined strings using vector x followed by the value as a relative percent in parenthesis.
#' @export
#' @examples
#' fv_num_percent(1:10)
#' fv_num_percent(1:10, x_digits = 0, y_digits = 1, sep = " ")
fv_num_percent <- function(x, x_digits = getOption("numformdigits"), y_digits = x_digits, sep = "", comma = TRUE, ...) {
